-- NeurallEmpire CMS Tables Migration (Fixed)
...
INSERT INTO products (name, slug, description, long_description, category, status, url, color, "order")
SELECT * FROM (VALUES
...
INSERT INTO testimonials (client_name, client_role, client_company, content, rating, featured)
SELECT * FROM (VALUES
